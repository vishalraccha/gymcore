  ...
  padding: 4,
    ...
    const handleLogin = async () => {
      ...
      try {
        ...
        // ⭐ REMOVE MANUAL ROUTING - Let (app)/_layout.tsx handle it
        // The auth state change will automatically trigger the correct redirect
        
        setIsLoading(false);
        
        // Navigation will happen automatically via AuthContext and (app)/_layout.tsx
